      ...
      <div className="max-w-4xl mx-auto px-4 py-16 font-sans text-center relative z-10">
        ...
        <div className="flex flex-col items-center gap-4 mt-12">
          ...
          <p className="text-sm text-gray-600 max-w-xl">
            Привіт! Мене звати [Ім’я], я волонтер із [місто/регіон]. Допомагаю
            людям, які постраждали від війни...
          </p>

          <p className="text-sm text-gray-500">
            📍 [Місто, країна, наприклад, Київ, Україна]
          </p>
        </div>
        ...
        <div className="mt-10">
          ...
          <div className="flex flex-col gap-3 items-center">
            ...
            <button className="border-1 border-black rounded-[20px] px-6 py-3 text-sm hover:bg-gray-100">
              Збір кормів для тварин у зоні бойових дій: [посилання на
              ініціативу]
            </button>
          </div>
        </div>
        ...
        <div className="mt-12 border-1 border-black p-3 rounded-[20px] max-w-xl mx-auto">
          ...
          <p className="text-sm text-gray-600 mb-4">
            Підпишись на мої ініціативи! Підпишись на розсилку, щоб отримувати
            новини про мої волонтерські проєкти та дізнаватися, як ти можеш
            допомогти.
          </p>
