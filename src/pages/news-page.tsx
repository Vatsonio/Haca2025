    ...
    <div className="flex flex-col w-full">
          ...
          <div className="w-full lg:max-w-[768px]">
            <div className="mb-8">
              ...
              <p className="text-sm sm:text-base md:text-lg font-roboto font-normal leading-relaxed">
                Дізнайтесь про життя наших тваринок, історії успіху та як ви
                можете допомогти.
              </p>
            </div>
            ...
            <div className="mb-8">
              <div className="flex flex-col sm:flex-row gap-4 md:gap-8">
                <div className="w-full sm:w-1/2 lg:w-[216px]">
                  <h3 className="text-base sm:text-lg md:text-xl font-roboto font-bold leading-7 mb-1">
                    Хто?
                  </h3>
      ...
      <div className="w-full bg-white py-16 lg:py-[112px] px-4 sm:px-8 lg:px-[80px]">
        ...
        <div className="max-w-[1280px] mx-auto flex flex-col lg:flex-row items-center gap-8 lg:gap-[80px]">
          ...
          <div className="w-full lg:w-1/2 flex flex-col order-1 lg:order-1">
            <p className="font-roboto text-sm font-medium text-gray-600 mb-2">
              Весняний день відкритих дверей у притулку
            </p>
            ...
            <p className="font-roboto text-base font-normal text-gray-700 mb-4 leading-relaxed">
              Шановні друзі, ми раді запросити вас на наш традиційний весняний
              день відкритих дверей, який відбудеться 20 квітня 2025 року! Це
              чудова нагода познайомитися з нашими котиками, песиками та іншими
              тваринами, які шукають дім. Ви зможете поспілкуватися з нашими
              волонтерами, дізнатися більше про те, як працює притулок, і,
              можливо, знайти нового члена сім’ї.
            </p>

            <p className="font-roboto text-base font-normal text-gray-700 mb-4 leading-relaxed">
              Ми підготували для вас цікаву програму: майстер-класи з догляду за
              тваринами, фотосесії з нашими улюбленцями та благодійний ярмарок.
              На ярмарку ви зможете придбати сувеніри ручної роботи, виготовлені
              нашими волонтерами, а всі зібрані кошти підуть на потреби
              притулку. Також ми організуємо невеликий фуршет, щоб ви могли
              відпочити та поспілкуватися з іншими любителями тварин.
            </p>

            <p className="font-roboto text-base font-normal text-gray-700 mb-6 leading-relaxed">
              Захід проходитиме з 10:00 до 16:00 за адресою: вул. Сонячна, 15,
              м. Київ. Ми будемо раді бачити всіх, хто хоче дізнатися більше про
              нашу діяльність або просто провести день у компанії милих
              тваринок. Чекаємо на вас із нетерпінням, адже разом ми можемо
              зробити більше для тих, хто потребує нашої турботи!
            </p>
      ...
      <div className="w-full bg-gray-50 py-16 lg:py-[112px] px-4 sm:px-8 lg:px-[80px]">
        ...
        <div className="max-w-[1280px] mx-auto flex flex-col lg:flex-row items-center gap-8 lg:gap-[80px]">
          ...
          <div className="w-full lg:w-1/2 flex flex-col order-2 lg:order-2 mt-8 lg:mt-0">
            <p className="font-roboto text-sm font-medium text-gray-600 mb-2">
              Мурчик знайшов дім: історія одного котика, який змінив усе
            </p>
            ...
            <p className="font-roboto text-base font-normal text-gray-700 mb-4 leading-relaxed">
              Мурчик потрапив до нас у 2024 році — маленьке кошеня, яке ми
              знайшли на вулиці в холодний осінній день. Він був наляканим,
              худим і потребував термінової медичної допомоги: у нього виявили
              інфекцію, а шерсть була в жахливому стані. Наші волонтери
              доглядали його, годували, лікували, і з часом Мурчик почав
              одужувати, стаючи все більш грайливим і довірливим.
            </p>

            <p className="font-roboto text-base font-normal text-gray-700 mb-4 leading-relaxed">
              Після кількох місяців у притулку Мурчик перетворився на пухнастого
              красеня з блискучою шерстю та веселим характером. Він любив сидіти
              на підвіконні, спостерігаючи за птахами, і муркотіти, коли хтось
              брав його на руки. У січні 2025 року його помітила сім’я з двох
              дітей, які одразу закохалися в цього котика і вирішили забрати
              його до себе.
            </p>

            <p className="font-roboto text-base font-normal text-gray-700 mb-6 leading-relaxed">
              Тепер Мурчик живе в теплому домі, обожнює спати на дивані та
              гратися з дітьми. Ця історія — лише одна з багатьох, які ми
              переживаємо щомісяця, але вона особлива, адже показує, як любов і
              турбота можуть змінити життя тварини. Ми вдячні всім, хто
              підтримує нас у цій важливій справі, і запрошуємо вас дізнатися,
              як ви можете допомогти іншим тваринам, таким як Мурчик, знайти
              свій дім.
            </p>
      ...
      <div className="w-full bg-white py-16 lg:py-[112px] px-4 sm:px-8 lg:px-[80px]">
        ...
        <div className="max-w-[1280px] mx-auto flex flex-col lg:flex-row items-center gap-8 lg:gap-[80px]">
          ...
          <div className="w-full lg:w-1/2 flex flex-col order-1 lg:order-1">
            <p className="font-roboto text-sm font-medium text-gray-600 mb-2">
              50 тваринок знайшли дім у 2025 році: разом ми досягли цієї мети!
            </p>
            ...
            <p className="font-roboto text-base font-normal text-gray-700 mb-4 leading-relaxed">
              Цей рік став особливим для притулку "Щаслива лапа". Завдяки вашій
              підтримці, невтомній роботі волонтерів та небайдужості наших
              відвідувачів ми змогли прилаштувати 50 тваринок у нові люблячі
              сім'ї! Серед них – 30 котиків, 15 песиків і навіть 5 кроликів, які
              тепер живуть у теплі та затишку.
            </p>

            <p className="font-roboto text-base font-normal text-gray-700 mb-4 leading-relaxed">
              Кожна історія прилаштування – це результат спільної роботи. Ми
              проводили регулярні акції, розповідали про наших підопічних у
              соціальних мережах і співпрацювали з місцевими громадами, щоб
              знайти для тваринок найкращих господарів. Особливо тішить те, що
              багато з наших тваринок, які провели в притулку понад рік, нарешті
              знайшли дім – це стало можливим завдяки вашій вірі в нашу місію.
            </p>

            <p className="font-roboto text-base font-normal text-gray-700 mb-6 leading-relaxed">
              Але ми не зупиняємося на досягнутому! У планах на другу половину
              2025 року – організувати ще більше заходів, залучити нових
              волонтерів і розширити наш притулок, щоб допомогти ще більшій
              кількості тварин. Дізнайтесь, як ми досягли цього результату, і
              долучайтесь до нашої команди, щоб разом продовжувати змінювати
              життя безпритульних тварин на краще.
            </p>
        ...
        <div className="max-w-[1440px] mx-auto">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-lg text-black mt-2">
              Найцiкавiшi моменти разом з улюбленцями!
            </p>
          </div>
